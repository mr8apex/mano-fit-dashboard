...
import { verifyResetOtp, resendOtp } from "@/api/auth.api";
...
const VerifyResetOtp = () => {
  ...
  const handleVerify = async () => {
    ...
    try {
      const res = await verifyResetOtp({ token, otp });
      if (res.success) {
        // Keep token for reset password page
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-fade-in">
        <div className="glass-strong rounded-2xl p-8 glow-box">
          ...
          <h2 className="text-xl font-display font-semibold mb-2 text-center">Verify Reset Code</h2>
