...
const Dashboard = () => {
  ...
  const features = [
    { icon: UtensilsCrossed, label: "Daily Diet", desc: "Log meals & get tips", color: "from-emerald-500/20 to-teal-500/20", iconColor: "text-emerald-400", onClick: () => setDietOpen(true) },
